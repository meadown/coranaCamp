//
//  criticalSympromsTableViewCell.swift
//  AwareCorona
//
...
class criticalSympromsTableViewCell: UITableViewCell,UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    
    var cellno: Int = 0
    var symptoms = SymptomsViewController.SymptomstImage["section2"]
